...
ggplot(avgSteps, aes(interval, meanOfSteps)) + geom_line(color = "red", size = 0.9) + labs(title = "Time Series Plot of the 5-minute Interval", x = "5-minute intervals", y = "Average Number of Steps Taken")
```
